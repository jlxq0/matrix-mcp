  ...
  "rooms": [
    {
      ...
      "unread_mentions": 1,
      "latest_event_id": "$abc:example.com",
...
**Returns:**
```json
{ "room_id": "!abc:example.com", "event_id": "$abc:example.com" }
```
...
**Returns:**
```json
{ "event_id": "$reactionEvent:example.com" }
```
...
**Returns:**
```json
{ "event_id": "$redactionEvent:example.com" }
```
...
```json
{
  "event_id": "$imageEvent:example.com",
  "mxc_uri": "mxc://example.com/abc123"
}
```
...
|---|---|---|---|
| `room_id` | string | required | Matrix room id |
| `mxid` | string | required | MXID to invite, e.g. `@alice:example.com` |
